...
class Consumer:
    def __init__(self, ccloud_config_file_path, model_name):
    ...
    def consume(self) -> NoReturn:
        while True:
            try:
                ...
                for field_name, field_type in changes['changed'].items():
                    self._db.change_field_type(self.model_name, field_name, field_type)
